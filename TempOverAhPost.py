...
df = pd.read_csv('Charge10A.csv', delimiter = ',', encoding="utf-8-sig")
colList = list(df.columns.values)
colIndices = ['1-10A', '2-10A']

x_range = [0,3000,500]   #midpoint = x_range[1] / 2
y_range = [3.5,4.4,.2]

var_of_interest = ['Volts']
title = '3A FIRST CHARGE'
...
plt.ylabel('VOLTAGE', fontproperties=prop, labelpad=20)
plt.xlabel('CAPACITY (mAh)', fontproperties=prop, labelpad=20)
